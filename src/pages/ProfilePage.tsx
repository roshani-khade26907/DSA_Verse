...
export const ProfilePage: React.FC = () => {
  const achievements = [
    { id: '1', title: 'First Problem', desc: 'Solved your first C++ problem on DSAverse', icon: '🏆', unlocked: true, date: 'Aug 01, 2026' },
    { id: '2', title: '7 Day Streak', desc: 'Maintained a 7-day continuous coding streak', icon: '🔥', unlocked: true, date: 'Aug 07, 2026' },
    { id: '3', title: '25 Problems Mastered', desc: 'Solved 25 curated C++ DSA problems', icon: '💻', unlocked: true, date: 'Aug 11, 2026' },
    { id: '4', title: 'Tree Explorer', desc: 'Complete Binary Tree BFS & DFS traversals', icon: '🌳', unlocked: false, date: 'Locked' },
    { id: '5', title: 'Speed Solver', desc: 'Solve an Easy C++ problem in under 5 minutes', icon: '⚡', unlocked: true, date: 'Aug 13, 2026' }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-8">
      ...
      {/* Profile Header Box */}
      <div className="p-8 rounded-3xl bg-gradient-to-r from-violet-950/80 via-purple-950/50 to-indigo-950/80 border border-purple-500/30 glass-panel shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center space-x-5">
          <img
            src={mockUser.avatar}
            alt={mockUser.name}
            className="w-20 h-20 rounded-full object-cover ring-4 ring-purple-500/50 shadow-xl"
          />
        ...
        <div className="space-y-2 text-right shrink-0">
          ...
          <ProgressBar progress={mockUser.overallProgress} color="purple" height="sm" className="w-36 ml-auto" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-2xl bg-slate-900/80 border border-purple-500/20 glass-panel space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            ...
            <span className="text-xs font-mono text-purple-400">4 / 5 Unlocked</span>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-slate-900/80 border border-purple-500/20 glass-panel space-y-4">
          ...
          <div className="space-y-4 text-xs">
            <div className="flex justify-between items-center p-3 rounded-xl bg-slate-950 border border-slate-800">
              ...
              <span className="font-mono font-bold text-purple-400">4 / 12</span>
            </div>
