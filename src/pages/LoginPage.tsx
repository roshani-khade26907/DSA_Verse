...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden bg-grid-pattern">
      ...
      {/* Auth Box */}
      <div className="w-full max-w-md bg-slate-900/90 border border-teal-500/30 rounded-3xl p-8 shadow-2xl glass-panel relative">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-xs pt-1">
            ...
            <a href="#forgot" onClick={(e) => { e.preventDefault(); alert('Reset password link sent to your email.'); }} className="text-teal-400 hover:text-teal-300">
              Forgot password?
            </a>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white font-bold text-xs shadow-lg shadow-teal-600/30 transition-all flex items-center justify-center space-x-2"
          >
        ...
        <div className="mt-6 pt-6 border-t border-slate-800/80 text-center text-xs text-slate-400">
          ...
          <Link to="/signup" className="text-teal-400 font-semibold hover:text-teal-300">
            Sign Up Free
          </Link>
        </div>
