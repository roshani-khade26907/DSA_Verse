...
export const MistakeJournalPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {/* Filters Bar */}
      <div className="p-4 rounded-2xl bg-slate-900/80 border border-purple-500/20 glass-panel flex flex-wrap items-center justify-between gap-4 text-xs">
          ...
          <div
            ...
            className={`p-6 rounded-2xl border transition-all ${
              entry.reviewed
                ...
                : 'bg-slate-900/80 border-purple-500/30 glass-panel shadow-xl'
            }`}
          >
