...
export const ProblemPracticePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-purple-500/15">
        <div>
          <h1 className="text-2xl sm:text-4xl font-extrabold text-white flex items-center">
            <Code2 className="w-8 h-8 mr-3 text-purple-400" />
        ...
        <div className="flex items-center space-x-3">
          <Link
            to="/mentor"
            className="px-4 py-2 rounded-xl bg-purple-600/20 border border-purple-500/30 text-purple-300 hover:bg-purple-600 hover:text-white text-xs font-semibold transition-all flex items-center space-x-1.5"
          >
      ...
      {/* Filter & Search Bar */}
      <div className="p-4 rounded-2xl bg-slate-900/80 border border-purple-500/20 glass-panel flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto text-xs">
          ...
          <select
            ...
            className="bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-purple-500"
          >
      ...
      {/* Problem Table */}
      <div className="rounded-2xl bg-slate-900/80 border border-purple-500/20 glass-panel overflow-hidden">
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-800/60 font-sans">
              {filteredProblems.map((prob) => (
                <tr key={prob.id} className="hover:bg-purple-950/20 transition-colors group">
                  ...
                  <td className="py-4 px-4 text-right">
                    <button
                      ...
                      className="px-3.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs shadow-md transition-all inline-flex items-center space-x-1"
                    >
