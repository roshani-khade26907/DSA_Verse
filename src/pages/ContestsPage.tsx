  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="space-y-4">
        <h2 className="text-sm font-bold uppercase tracking-wider text-teal-400 flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {mockContests.filter(c => c.status !== 'Ended').map((contest) => (
            <div
              key={contest.id}
              className="p-6 rounded-3xl bg-slate-900/80 border border-teal-500/30 glass-panel shadow-xl space-y-4 flex flex-col justify-between"
            >
        ...
        <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 glass-panel">
          <div className="flex items-center justify-between text-xs">
            <div>
              ...
              <p className="text-slate-400 mt-0.5">Sun, Aug 10, 2026 â€¢ 2,150 Participants</p>
            </div>
